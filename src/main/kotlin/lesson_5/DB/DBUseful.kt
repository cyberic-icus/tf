...
fun prepareAndExecute(dataBaseSevice: DataBaseSevice, query: String) {
    val preparedStatement = dataBaseSevice.conn.prepareStatement(query)
    preparedStatement.execute()
}

fun prepareAndExecuteQuery(dataBaseSevice: DataBaseSevice, query: String): ResultSet {
    val preparedStatement = dataBaseSevice.conn.prepareStatement(query)
